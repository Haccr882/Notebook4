...
import { callWithFallback, callGeminiVision } from './providers.js';
import { checkPremiumToken, checkAndIncrementLimit, resolveIdentity } from './_limits.js';
...
export default async function handler(req, res) {
  ...
  if (mode !== 'plan' && mode !== 'section' && mode !== 'judge' && mode !== 'visual-judge') {
    return res.status(400).json({ error: 'Request must include mode: "plan", "section", "judge", or "visual-judge".' });
  }
